function crimping(rStent, rCrimpedStent, initial_positions_stent, connectivity_stent, output_dir_crimping)


    if !isdir(output_dir_crimping)
        println("Create directory")
        mkdir(output_dir_crimping)
    end
